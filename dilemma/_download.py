...
https://huggingface.co/ciscoriordan/dilemma. The base download is ~4.3 GB
(lemma `data/` + `model/` ~2.8 GB and tagger weights ~1.5 GB); the two opt-in
form-attestation DBs add ~1.36 GB more (~5.7 GB for everything).
