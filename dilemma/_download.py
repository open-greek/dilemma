...
https://huggingface.co/ciscoriordan/dilemma. The base download is ~3.7 GB
(lemma `data/` ~1.8 GB + `model/` ~0.07 GB + tagger weights ~1.8 GB); the
two opt-in form-attestation DBs add ~1.2 GB more (~4.9 GB for everything).
